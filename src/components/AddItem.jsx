            ...
            <div className=' flex dark:text-white justify-between items-center'>
                <div className=' flex flex-wrap '>
                    ...
                    <div className=' flex px-2 py-2  flex-col items-start'>
                        ...
                        <div className=' max-w-[100px] dark:bg-[#414da8] py-2 px-4 border-[.2px] rounded-lg focus:outline-none   focus:outline-purple-400 border-gray-300 dark:border-gray-800 dark:text-white'>
                            {itemDetails.total}
                        </div>
                    </div>
                </div>
