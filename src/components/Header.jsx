...
function Header() {
  ...
  return (
    <div  >
      {/* Header */}
      <header className=' lg:hidden h-[80px] z-50  duration-300 ease-in-out  p-4  dark:bg-[#16171e]  bg-[#828bbd] flex items-center justify-end   '>
        ...
        <div className='  flex  items-center  '>
          ...
          <div className=' h-[80px] border-dotted border-l border-[#e2e4f4] mx-6'>
      ...
      <div className=' z-50 hidden lg:block '>
        <div className=' fixed  z-50  w-[100px] rounded-r-3xl  flex-col  top-0 left-0 h-screen dark:bg-[#3e3f49]  bg-[#2c345f]'>
